...
fso.CreateFolder Uninstall&"\Age of Mythology The Titans Expansion"
...
Install(6) = "70|.|Copiando Arquivos...|.|XAOM.bmp|.|"& InstallLocation &"\Settings\Images|.|"& OPFolder &"\Settings\Images|.|"
Install(7) = "80|.|Copiando Arquivos...|.|localex.cfg|.|"& InstallLocation &"\startup|.|"& Destination &"\startup|.|"
Install(8) = "90|.|Copiando Arquivos...|.|xpacklanguage.dll|.|"& InstallLocation &"|.|"& Destination &"|.|"
Install(9) = "95|.|Preparando Desinstalador...|.|Uninstall.exe|.|"& InstallLocation &"|.|"& Uninstall &"\Age of Mythology The Titans Expansion|.|"
...
If NOT (fso.FileExists(Destination&"\startup\localex.cfg.tgbackup")) Then
fso.MoveFile Destination&"\startup\localex.cfg", Destination&"\startup\localex.cfg.tgbackup"
End If

If NOT (fso.FileExists(Destination&"\xpacklanguage.dll.tgbackup")) Then
fso.MoveFile Destination&"\xpacklanguage.dll", Destination&"\xpacklanguage.dll.tgbackup"
End If
