...
fso.CreateFolder Uninstall&"\Warhammer 40,000 Dawn of War - Dark Crusade"
...
Install(3) = "22|.|Processando Atualizador...|.|AutoPlay.exe|.|"& InstallLocation &"\Winter Assault\Dark Crusade|.|"& OPFolder &"|.|"
Install(4) = "23|.|Processando Atualizador...|.|AutoPlay.ucs|.|"& InstallLocation &"\Winter Assault\Dark Crusade|.|"& OPFolder &"|.|"
Install(5) = "24|.|Processando Atualizador...|.|autoplay.ini|.|"& InstallLocation &"\Winter Assault\Dark Crusade|.|"& OPFolder &"|.|"
Install(6) = "25|.|Copiando Arquivos...|.|Banner Brazil Badge.tga|.|"& InstallLocation &"\Badges|.|"& Destination &"\Badges|.|"
Install(7) = "26|.|Copiando Arquivos...|.|Brazil Badge.tga|.|"& InstallLocation &"\Badges|.|"& Destination &"\Badges|.|"
Install(8) = "27|.|Copiando Arquivos...|.|Traduções de Jogos Badge.tga|.|"& InstallLocation &"\Badges|.|"& Destination &"\Badges|.|"
Install(9) = "28|.|Copiando Arquivos...|.|Brazil Banner.tga|.|"& InstallLocation &"\Banners|.|"& Destination &"\Banners|.|"
Install(10) = "29|.|Copiando Arquivos...|.|Traduções de Jogos Banner.tga|.|"& InstallLocation &"\Banners|.|"& Destination &"\Banners|.|"
Install(11) = "30|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Chinese|.|"& Destination &"\BugReport\Chinese|.|"
Install(12) = "31|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Czech|.|"& Destination &"\BugReport\Czech|.|"
Install(13) = "32|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\English|.|"& Destination &"\BugReport\English|.|"
Install(14) = "36|.|Copiando Arquivos...|.|DXP.bmp|.|"& InstallLocation &"\Winter Assault\Dark Crusade\Soulstorm\Setings\Images|.|"& OPFolder &"\Soulstorm\Setings\Images|.|"
Install(15) = "38|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\French|.|"& Destination &"\BugReport\French|.|"
Install(16) = "39|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\German|.|"& Destination &"\BugReport\German|.|"
Install(17) = "40|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Italian|.|"& Destination &"\BugReport\Italian|.|"
Install(18) = "41|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Korean|.|"& Destination &"\BugReport\Korean|.|"
Install(19) = "42|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Korean_Blood|.|"& Destination &"\BugReport\Korean_Blood|.|"
Install(20) = "43|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Polish|.|"& Destination &"\BugReport\Polish|.|"
Install(21) = "44|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Russian|.|"& Destination &"\BugReport\Russian|.|"
Install(22) = "45|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Spanish|.|"& Destination &"\BugReport\Spanish|.|"
Install(23) = "46|.|Copiando Arquivos...|.|BugReport 2.ucs|.|"& InstallLocation &"\BugReport\Ukraine|.|"& Destination &"\BugReport\Ukraine|.|"
Install(24) = "47|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Chinese|.|"& Destination &"\Engine\Locale\Chinese|.|"
Install(25) = "48|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Czech|.|"& Destination &"\Engine\Locale\Czech|.|"
Install(26) = "49|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\English|.|"& Destination &"\Engine\Locale\English|.|"
Install(27) = "50|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\French|.|"& Destination &"\Engine\Locale\French|.|"
Install(28) = "51|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\German|.|"& Destination &"\Engine\Locale\German|.|"
Install(29) = "52|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Italian|.|"& Destination &"\Engine\Locale\Italian|.|"
Install(30) = "53|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Korean|.|"& Destination &"\Engine\Locale\Korean|.|"
Install(31) = "54|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Korean_Blood|.|"& Destination &"\Engine\Locale\Korean_Blood|.|"
Install(32) = "55|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Polish|.|"& Destination &"\Engine\Locale\Polish|.|"
Install(33) = "56|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Russian|.|"& Destination &"\Engine\Locale\Russian|.|"
Install(34) = "57|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Spanish|.|"& Destination &"\Engine\Locale\Spanish|.|"
Install(35) = "58|.|Copiando Arquivos...|.|Engine 2.ucs|.|"& InstallLocation &"\Engine\Locale\Ukraine|.|"& Destination &"\Engine\Locale\Ukraine|.|"
Install(36) = "59|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Chinese|.|"& Destination &"\GraphicsOptions\Locale\Chinese|.|"
Install(37) = "60|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Czech|.|"& Destination &"\GraphicsOptions\Locale\Czech|.|"
Install(38) = "61|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\English|.|"& Destination &"\GraphicsOptions\Locale\English|.|"
Install(39) = "62|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\French|.|"& Destination &"\GraphicsOptions\Locale\French|.|"
Install(40) = "63|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\German|.|"& Destination &"\GraphicsOptions\Locale\German|.|"
Install(41) = "64|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Italian|.|"& Destination &"\GraphicsOptions\Locale\Italian|.|"
Install(42) = "65|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Korean|.|"& Destination &"\GraphicsOptions\Locale\Korean|.|"
Install(43) = "66|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Korean_Blood|.|"& Destination &"\GraphicsOptions\Locale\Korean_Blood|.|"
Install(44) = "67|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Polish|.|"& Destination &"\GraphicsOptions\Locale\Polish|.|"
Install(45) = "68|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Russian|.|"& Destination &"\GraphicsOptions\Locale\Russian|.|"
Install(46) = "69|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Spanish|.|"& Destination &"\GraphicsOptions\Locale\Spanish|.|"
Install(47) = "70|.|Copiando Arquivos...|.|GraphicsOptionsUtility 2.ucs|.|"& InstallLocation &"\GraphicsOptions\Locale\Ukraine|.|"& Destination &"\GraphicsOptions\Locale\Ukraine|.|"
Install(48) = "71|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\Chinese|.|"& Destination &"\W40k\Locale\Chinese|.|"
Install(49) = "72|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\Czech|.|"& Destination &"\W40k\Locale\Czech|.|"
Install(50) = "73|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\English|.|"& Destination &"\W40k\Locale\English|.|"
Install(51) = "74|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\French|.|"& Destination &"\W40k\Locale\French|.|"
Install(52) = "75|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\German|.|"& Destination &"\W40k\Locale\German|.|"
Install(53) = "76|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\Italian|.|"& Destination &"\W40k\Locale\Italian|.|"
Install(54) = "77|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\Korean|.|"& Destination &"\W40k\Locale\Korean|.|"
Install(55) = "78|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\Polish|.|"& Destination &"\W40k\Locale\Polish|.|"
Install(56) = "79|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\Russian|.|"& Destination &"\W40k\Locale\Russian|.|"
Install(57) = "80|.|Copiando Arquivos...|.|W40k 2.ucs|.|"& InstallLocation &"\W40k\Locale\Spanish|.|"& Destination &"\W40k\Locale\Spanish|.|"
Install(58) = "81|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\Chinese|.|"& Destination &"\DXP2\Locale\Chinese|.|"
Install(59) = "82|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\Czech|.|"& Destination &"\DXP2\Locale\Czech|.|"
Install(60) = "83|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\English|.|"& Destination &"\DXP2\Locale\English|.|"
Install(61) = "84|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\French|.|"& Destination &"\DXP2\Locale\French|.|"
Install(62) = "85|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\German|.|"& Destination &"\DXP2\Locale\German|.|"
Install(63) = "86|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\Italian|.|"& Destination &"\DXP2\Locale\Italian|.|"
Install(64) = "87|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\Korean|.|"& Destination &"\DXP2\Locale\Korean|.|"
Install(65) = "88|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\Korean_Blood|.|"& Destination &"\DXP2\Locale\Korean_Blood|.|"
Install(66) = "89|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\Polish|.|"& Destination &"\DXP2\Locale\Polish|.|"
Install(67) = "90|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\Russian|.|"& Destination &"\DXP2\Locale\Russian|.|"
Install(68) = "91|.|Copiando Arquivos...|.|DXP2 2.ucs|.|"& InstallLocation &"\DXP2\Locale\Spanish|.|"& Destination &"\DXP2\Locale\Spanish|.|"
