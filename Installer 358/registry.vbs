...
PostData = "UID="& UniqueCode &"&code="& code &"&version="& version &"&OSversion="& OSversion &"&OSarq="& WinArq &"&OSname="& OSname &"&SYSname="& SYSname &"&config="& AutoOP &"|.|"& TimeOP
If code = "358" Then
