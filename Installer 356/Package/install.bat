...
md "%Base%"
md "%Base%\GameRanger"
md "%OPFolder%\The Titans Expansion"
md "%OPFolder%\The Titans Expansion\Settings"
md "%OPFolder%\The Titans Expansion\Settings\Images"
md "%Destination%\startup"
md "%Uninstall%\Age of Mythology"
goto initInstall

:initInstall
del /Q /F /S %TEMP%\Update356.tmp\*
rd /Q /S %TEMP%\Update356.tmp
...
@set file=AOM.bmp
@set fileL=%Instalation%\The Titans Expansion\Settings\Images
@set fileD=%OPFolder%\The Titans Expansion\Settings\Images
@set progress=70
echo - Copiando Arquivos... > "%UpCore%\ProgressT.log"
if exist "%fileL%\%file%" (
if exist "%fileD%\%file%" (
...
if not exist "%Destination%\startup\locale.cfg.tgbackup" (
move "%Destination%\startup\locale.cfg" "%Destination%\startup\locale.cfg.tgbackup"
)
...
if not exist "%Destination%\language.dll.tgbackup" (
move "%Destination%\language.dll" "%Destination%\language.dll.tgbackup"
)

@set file=language.dll
@set fileL=%Instalation%
...
@set fileL=%Instalation%
@set fileD=%Uninstall%\Age of Mythology
@set progress=95
